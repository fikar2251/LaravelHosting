@extends('layouts.app')
@section('title', 'Kenaikan Pangkat List')
@push('bread')
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header d-flex flex-row justify-content-between">
                ...
                <a href="{{ route('admin.kenaikan_pangkat.create') }}" class="btn btn-sm btn-primary">Create New</a>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-striped" id="datatable">
                        ...
                        <tbody>
                            @foreach($kenaikan_pangkats as $data)
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a href="{{ route('admin.kenaikan_pangkat.edit', $data->id) }}" class="btn btn-sm btn-warning">Edit</a>
