                            ...
                            <table class="table table-borderless">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <th>:</th>
                                        <th>
                                            <input type="text" oninput="rupiah(this),penerimaan(this)" value="0" name="penerimaan[{{ $terima->nama }}]" class="form-control penerimaan">
                                        </th>
                                    </tr>
                                    @endforeach
                                </tbody>
                                <tfoot>
                                    <tr>
                                        ...
                                        <th>:</th>
                                        <th>
                                            <input type="text" name="total_penerimaan" readonly value="0" id="total_penerimaan" class="form-control">
                                        </th>
                                    </tr>
                                </tfoot>
                            </table>
                            ...
                            <table class="table table-borderless">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <th>:</th>
                                        <th>
                                            <input type="text" oninput="rupiah(this),potongan(this)" value="0" name="potongan[{{ $potong->nama }}]" class="form-control potongan">
                                        </th>
                                    </tr>
                                    @endforeach
                                </tbody>
                                <tfoot>
                                    <tr>
                                        ...
                                        <th>:</th>
                                        <th>
                                            <input type="text" name="total_potongan" readonly value="0" id="total_potongan" class="form-control">
                                        </th>
                                    </tr>
                                </tfoot>
                            </table>
