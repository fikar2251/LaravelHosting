                        ...
                        <table class="table table-borderless">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <th>:</th>
                                    <th>
                                        <input type="text" value="{{ $penggajian->pegawai->nama }}" class="form-control">
                                    </th>
                                </tr>
                                <tr>
                                    <th>Tanggal</th>
                                ...
                                <tr>
                                    ...
                                    <th>:</th>
                                    <th>
                                        <input type="month" value="{{ Carbon\Carbon::parse($penggajian->tanggal)->format('F') }}" name="yearmonth" class="form-control">
                                    </th>
                                </tr>
                            </tbody>
                        </table>
