            ...
            <div class="main-profile-body">
                <div class="tab-content">
                    ...
                    <div class="tab-pane" id="file">
                        @include('admin.pegawai.file')
                    </div>
                    <div class="tab-pane" id="diklat">
                        @include('admin.pegawai.diklat')
                    </div>
                    <div class="tab-pane" id="pelanggaran">
                        @include('admin.pegawai.pelanggaran')
                    </div>
                    <div class="tab-pane" id="mutasi">
                        @include('admin.pegawai.mutasi')
                    </div>
                </div>
            </div>
            <!-- main-profile-body -->
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#datatablefilepegawai').DataTable({
            ...
            processing: true,
            destroy: true,
            ajax: `/api/admin/pegawai/filepegawai/${id}`,
            columns: [
                {
                    data: 'file',
                    name: 'file'
    ...
    $('#buttonfile').on('click', function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                console.log(response)
                $('#datatablefilepegawai').DataTable().ajax.url(`/api/admin/pegawai/filepegawai/${id}`).load()
                swal({
                    title: "Successfully",
                    text: response,
                    type: "success",
    ...
    function buttonfilepegawaidelete(qr){
        ...
        swal({
            ...
            $.ajax({
                url: `/api/admin/pegawai/filepegawai/delete/${data_id}`,
                success: function(response) {
                    setTimeout(function() {
                        $('#datatablefilepegawai').DataTable().ajax.url(`/api/admin/pegawai/filepegawai/${id}`).load()
                        swal({
