...
<head>
    ...
    <title>Laporan Surat Masuk {{ $from }} - {{ $to }}</title>
</head>
<!-- Bootstrap -->
                ...
                <table class="table table-striped table-bordered" id="datatable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <ul>
                                    @foreach($data->disposisi as $list)
                                    <li>{{ $list->tujuan }} - <a href="{{ route('admin.pegawai.show',$list->pegawai_id) }}">{{ $list->pegawai->nama }}</a></li>
                                    @endforeach
                                </ul>
                            </td>
                        </tr>
